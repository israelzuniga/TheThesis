...
\ifpdf  
    \pdfinfo { /Title  (Dise\~{n}o y Fabricaci\'{o}n De Un Pico-Sat\'{e}lite Artificial Mediante Las Normas CanSat)
               /Creator (TeX)
               /Producer (pdfTeX)
               /Author (Israel Zu\~{n}iga de la Mora israelzuniga@ucol.mx)
...
%  % Just search for the "city" and you'll find them.
  \collegeordept{\href{http://telematicanet.ucol.mx}{Facultad de Telem\'{a}tica}}
  \university{\href{http://www.ucol.mx}{Universidad de Colima}}

  % The crest is a graphics file of the logo of your research institution.
  % Place it in ./0_frontmatter/figures and specify the width
  \crest{\includegraphics[width=4cm]{escudo-ucol}}
  
% If you are not creating a PDF then use the following. The default is PDF.
\else
  \author{Israel Zu\~{n}iga de la Mora}
%  \cityofbirth{born in XYZ}
  \collegeordept{Facultad de Telem\'{a}tica}
  \university{Universidad de Colima}
  \crest{\includegraphics[width=4cm]{escudo-ucol}}
\fi

%\renewcommand{\submittedtext}{change the default text here if needed}
\degree{Ingenier\'{i}a en Telem\'{a}tica}
\degreedate{Junio 2011}
...
%\newpage
\vspace{10mm}
1. Asesor: Profesor Omar \'{A}lvarez C\'{a}rdenas
...
%martes 7 de junio - suprimido abstract
...
\include{2/EstadoDelArte}						% estado del arte

\include{3/Metodologia}			
\include{4/Calendario}	
%\include{5/XYZ}
%\include{6/XYZ}

...
?>
      <div id="content">
        ...
        <img src="img/israelz.jpg" alt="El autor" style="margin: 10px;"/><p>Mi nombre es Israel Zu&ntilde;iga de la Mora, estudiante de la Facultad de Telem&aacute;tica en la Universidad de Colima. Actualmente curso la Ingenier&iacute;a en Telem&aacute;tica en su 6to. semestre.<br/>
	...
	<p>
		As&iacute; tambi&eacute;n, se puede consultar el avance en el trabajo, como dise&ntilde;os esquem&aacute;ticos o de PCBs y c&oacute;digos fuente creados y empleados en este mismo trabajo. <a href="https://github.com/israelzuniga/TheThesis">En el repositorio creado para dicho fin.</a><br/> 
	<a href="mailto:israelzuniga@ucol.mx">Contacto hac&iacute;a el estudiante</a>
		</p>
Actualizado en <strong>13 de Junio de 2011</strong>
      </div>
<?php
    include('footer.inc');
    ?>